...
let SportsService = class SportsService {
    ...
    async update(id, data) {
        ...
        if (data.scoringRules)
            updateData.scoringRules = JSON.stringify(data.scoringRules);
        if (data.statFields)
            updateData.statFields = JSON.stringify(data.statFields);
        if (data.pointsSystem)
            updateData.pointsSystem = JSON.stringify(data.pointsSystem);
        if (data.tieBreakerRules)
            updateData.tieBreakerRules = JSON.stringify(data.tieBreakerRules);
