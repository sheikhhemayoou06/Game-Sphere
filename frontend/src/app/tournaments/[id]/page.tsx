    ...
    if (loading) return (
        <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'linear-gradient(135deg, #0f172a 0%, #020617 100%)' }}>
            <div style={{ textAlign: 'center' }}>
                ...
                <div style={{ color: "inherit", fontSize: '14px' }}>Loading tournament...</div>
            </div>
        </div>
    );
    ...
    if (!tournament) return (
        <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#0f172a' }}>
            <div style={{ textAlign: 'center', color: "inherit" }}>
                ...
                <Link href="/tournaments" style={{ color: "inherit", marginTop: '12px', display: 'inline-block' }}>← Back to tournaments</Link>
            </div>
        </div>
    );
    ...
    return (
        <div style={{ minHeight: '100vh', background: 'linear-gradient(135deg, #0f172a 0%, #020617 50%, #0f172a 100%)' }}>
            ...
            <nav style={{ padding: '14px 32px', background: 'rgba(15,23,42,0.95)', borderBottom: '1px solid rgba(255,255,255,0.06)', display: 'flex', alignItems: 'center', justifyContent: 'space-between', backdropFilter: 'blur(16px)' }}>
                <Link href="/dashboard" style={{ display: 'flex', alignItems: 'center', gap: '10px', textDecoration: 'none', color: "inherit", fontSize: '14px' }}>
                    ← Dashboard Home
                </Link>
                <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                    <span style={{ fontSize: '20px' }}>{sportEmoji}</span>
                    <span style={{ fontWeight: 800, fontSize: '16px', color: '#fff' }}>{tournament.name} <span style={{ color: "inherit" }}>/</span> <span style={{ color: "inherit" }}>{currentTabLabel}</span></span>
                ...
                <div style={{ fontSize: '12px', color: "inherit" }}>{tournament.sport?.name} • {tournament.format}</div>
            </nav>
            ...
            <div style={{ padding: '24px 32px', maxWidth: '1200px', margin: '0 auto' }}>
                ...
                {tab === 'overview' && (
                    <div>
                        <div className="responsive-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '16px', marginBottom: '24px' }}>
                            {[
                                { label: 'Teams', value: stats?.totalTeams || 0, icon: '👥', color: "inherit" },
                                { label: 'Approved', value: stats?.approvedTeams || 0, icon: '✅', color: "inherit" },
                                { label: 'Matches', value: stats?.totalMatches || 0, icon: '📅', color: "inherit" },
                                { label: 'Live', value: stats?.liveMatches || 0, icon: '🔴', color: "inherit" },
                            ].map(card => (
                                <div key={card.label} style={{ padding: '24px', borderRadius: '16px', background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.06)' }}>
                                    ...
                                    <div style={{ fontSize: '12px', color: "inherit", fontWeight: 600 }}>{card.label}</div>
                                </div>
                            ))}
                        </div>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0, 1fr)', gap: '16px' }}>
                            <div style={{ padding: '24px', borderRadius: '16px', background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.06)' }}>
                                <h3 style={{ color: "inherit", fontWeight: 800, marginBottom: '16px' }}>📋 Tournament Info</h3>
                                {[
                                    ...
                                    <div key={label as string} style={{ display: 'flex', justifyContent: 'space-between', padding: '8px 0', borderBottom: '1px solid rgba(255,255,255,0.04)' }}>
                                        <span style={{ color: "inherit", fontSize: '13px' }}>{label}</span>
                                        <span style={{ color: "inherit", fontSize: '13px', fontWeight: 600 }}>{val}</span>
                                    </div>
                                ))}
                            </div>
                        </div>
                ...
                {tab === 'teams' && (
                    <div>
                        <h2 style={{ color: "inherit", fontWeight: 800, fontSize: '22px', marginBottom: '20px' }}>👥 Teams & Registrations</h2>

                        {/* Summary Dashboard */}
                        {isOrganizer && (
                            <div className="responsive-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '16px', marginBottom: '24px' }}>
                                <div style={{ padding: '20px', borderRadius: '14px', background: 'rgba(99,102,241,0.05)', border: '1px solid rgba(99,102,241,0.15)' }}>
                                    <div style={{ fontSize: '12px', color: "inherit", fontWeight: 600, marginBottom: '4px' }}>TOTAL APPLICATIONS</div>
                                    <div style={{ fontSize: '24px', fontWeight: 800, color: "inherit" }}>{teams.length}</div>
                                </div>
                                <div style={{ padding: '20px', borderRadius: '14px', background: 'rgba(34,197,94,0.05)', border: '1px solid rgba(34,197,94,0.15)' }}>
                                    <div style={{ fontSize: '12px', color: "inherit", fontWeight: 600, marginBottom: '4px' }}>APPROVED</div>
                                    <div style={{ fontSize: '24px', fontWeight: 800, color: "inherit" }}>{teams.filter(t => t.status === 'APPROVED').length}</div>
                                </div>
                                <div style={{ padding: '20px', borderRadius: '14px', background: 'rgba(245,158,11,0.05)', border: '1px solid rgba(245,158,11,0.15)' }}>
                                    <div style={{ fontSize: '12px', color: "inherit", fontWeight: 600, marginBottom: '4px' }}>PENDING</div>
                                    <div style={{ fontSize: '24px', fontWeight: 800, color: "inherit" }}>{teams.filter(t => t.status === 'PENDING').length}</div>
                                </div>
                                <div style={{ padding: '20px', borderRadius: '14px', background: 'rgba(239,68,68,0.05)', border: '1px solid rgba(239,68,68,0.15)' }}>
                                    <div style={{ fontSize: '12px', color: "inherit", fontWeight: 600, marginBottom: '4px' }}>REJECTED</div>
                                    <div style={{ fontSize: '24px', fontWeight: 800, color: "inherit" }}>{teams.filter(t => t.status === 'REJECTED').length}</div>
                                </div>
                            </div>
                        )}

                        {teams.length === 0 ? (
                            <div style={{ textAlign: 'center', padding: '48px', color: "inherit", background: 'rgba(255,255,255,0.03)', borderRadius: '16px' }}>
                                ...
                                {teams.map((tt: any) => (
                                    <div key={tt.id} style={{ padding: '20px', borderRadius: '14px', background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.06)', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                                        <div style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
                                            ...
                                            <div>
                                                <div style={{ fontWeight: 700, color: "inherit", fontSize: '15px' }}>{tt.team?.name}</div>
                                        ...
                                        <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                                            ...
                                            {isOrganizer && tt.status === 'APPROVED' && (
                                                <button onClick={() => {
                                                    ...
                                                    style={{ padding: '6px 12px', borderRadius: '8px', border: 'none', background: 'rgba(239,68,68,0.1)', color: "inherit", fontSize: '11px', fontWeight: 700, cursor: 'pointer' }}>
                                                    Cancel Registration
                                                </button>
                                            )}
                                            {user?.id === tt.team?.managerId && (tt.status === 'PENDING' || tt.status === 'APPROVED') && (
                                                <button onClick={() => {
                                                    ...
                                                    style={{ padding: '6px 12px', borderRadius: '8px', border: '1px solid #ef4444', background: 'transparent', color: "inherit", fontSize: '11px', fontWeight: 700, cursor: 'pointer' }}>
                                                    Withdraw
                                                </button>
                                            )}
                                        </div>
                ...
                {tab === 'fixtures' && (
                    <div>
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
                            <h2 style={{ color: "inherit", fontWeight: 800, fontSize: '22px' }}>📅 Fixtures</h2>
                                ...
                                {tournament.matches.map((m: any) => (
                                    <div key={m.id} style={{ padding: '18px', borderRadius: '14px', background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.06)', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                                        <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
                                            <span style={{ color: "inherit", fontSize: '12px', fontWeight: 600, width: '60px' }}>{m.round}</span>
                                            <span style={{ color: "inherit", fontWeight: 700, fontSize: '14px' }}>{m.homeTeam?.name || 'TBD'}</span>
                                            <span style={{ color: "inherit", fontSize: '12px' }}>vs</span>
                                            <span style={{ color: "inherit", fontWeight: 700, fontSize: '14px' }}>{m.awayTeam?.name || 'TBD'}</span>
                                        </div>
                                        <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                                            {m.venue && <span style={{ color: "inherit", fontSize: '11px' }}>📍 {m.venue}</span>}
                                            <span style={{
                ...
                {tab === 'scoring' && (
                    <div>
                        <h2 style={{ color: "inherit", fontWeight: 800, fontSize: '22px', marginBottom: '20px' }}>🔴 Live Scoring</h2>
                        <div style={{ textAlign: 'center', padding: '48px', borderRadius: '16px', background: 'rgba(255,255,255,0.03)' }}>
                            ...
                            <p style={{ color: "inherit", fontSize: '14px' }}>Select a match from Fixtures tab to start live scoring.</p>
                            <p style={{ color: "inherit", fontSize: '12px', marginTop: '8px' }}>Scoring uses {config.stat} as the primary stat for {tournament.sport?.name}</p>
                            <div style={{ marginTop: '16px', display: 'flex', gap: '8px', justifyContent: 'center', flexWrap: 'wrap' }}>
                                {config.events?.map((ev: any) => (
                                    <span key={ev.type} style={{ padding: '6px 14px', borderRadius: '8px', background: 'rgba(99,102,241,0.1)', color: "inherit", fontSize: '12px', fontWeight: 600 }}>
                                        {ev.label}
                                    </span>
                                ))}
                            </div>
                ...
                {tab === 'transfers' && (
                    <div>
                        <h2 style={{ color: "inherit", fontWeight: 800, fontSize: '22px', marginBottom: '20px' }}>🔄 Transfer Window</h2>
                        <div style={{ textAlign: 'center', padding: '48px', color: "inherit", background: 'rgba(255,255,255,0.03)', borderRadius: '16px' }}>
                ...
                {tab === 'financials' && financials && (
                    <div>
                        <h2 style={{ color: "inherit", fontWeight: 800, fontSize: '22px', marginBottom: '20px' }}>💰 Financial Dashboard</h2>
                        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '16px', marginBottom: '24px' }}>
                            <div style={{ padding: '24px', borderRadius: '16px', background: 'rgba(34,197,94,0.06)', border: '1px solid rgba(34,197,94,0.15)' }}>
                                <div style={{ fontSize: '11px', color: "inherit", fontWeight: 600, marginBottom: '6px' }}>TOTAL COLLECTED</div>
                                <div style={{ fontSize: '28px', fontWeight: 900, color: "inherit" }}>₹{financials.totalCollected?.toLocaleString()}</div>
                            </div>
                            <div style={{ padding: '24px', borderRadius: '16px', background: 'rgba(245,158,11,0.06)', border: '1px solid rgba(245,158,11,0.15)' }}>
                                <div style={{ fontSize: '11px', color: "inherit", fontWeight: 600, marginBottom: '6px' }}>PENDING</div>
                                <div style={{ fontSize: '28px', fontWeight: 900, color: "inherit" }}>{financials.pendingPayments}</div>
                            </div>
                            <div style={{ padding: '24px', borderRadius: '16px', background: 'rgba(99,102,241,0.06)', border: '1px solid rgba(99,102,241,0.15)' }}>
                                <div style={{ fontSize: '11px', color: "inherit", fontWeight: 600, marginBottom: '6px' }}>REGISTRATIONS</div>
                                <div style={{ fontSize: '28px', fontWeight: 900, color: "inherit" }}>{financials.totalRegistrations}</div>
                            </div>
                        </div>
                                    ...
                                    <thead>
                                        <tr style={{ borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
                                            {['Amount', 'Status', 'Method', 'Date'].map(h => (
                                                <th key={h} style={{ padding: '12px 16px', textAlign: 'left', fontSize: '11px', fontWeight: 700, color: "inherit", textTransform: 'uppercase' as const }}>{h}</th>
                                            ))}
                                        </tr>
                                    </thead>
                                    <tbody>
                                        {financials.payments.map((p: any) => (
                                            <tr key={p.id} style={{ borderBottom: '1px solid rgba(255,255,255,0.03)' }}>
                                                <td style={{ padding: '12px 16px', color: "inherit", fontWeight: 600, fontSize: '13px' }}>₹{p.amount}</td>
                                                ...
                                                <td style={{ padding: '12px 16px', color: "inherit", fontSize: '12px' }}>{p.method || 'N/A'}</td>
                                                <td style={{ padding: '12px 16px', color: "inherit", fontSize: '12px' }}>{formatDate(p.createdAt)}</td>
                                            </tr>
                                        ))}
                                    </tbody>
                                </table>
                ...
                {tab === 'leaderboard' && (
                    <div>
                        <h2 style={{ color: "inherit", fontWeight: 800, fontSize: '22px', marginBottom: '20px' }}>🏅 Leaderboard</h2>
                                    ...
                                    <thead>
                                        <tr style={{ borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
                                            {['#', 'Team', 'P', 'W', 'L', 'D', 'Pts'].map(h => (
                                                <th key={h} style={{ padding: '12px 16px', textAlign: h === 'Team' ? 'left' : 'center', fontSize: '11px', fontWeight: 700, color: "inherit" }}>{h}</th>
                                            ))}
                                        </tr>
                                    </thead>
                                    <tbody>
                                        {leaderboard.map((row: any, i: number) => (
                                            <tr key={row.teamId} style={{ borderBottom: '1px solid rgba(255,255,255,0.03)', background: i < 2 ? 'rgba(99,102,241,0.04)' : 'transparent' }}>
                                                ...
                                                <td style={{ padding: '12px 16px', fontWeight: 700, color: "inherit", fontSize: '14px' }}>{row.teamName}</td>
                                                <td style={{ padding: '12px 16px', textAlign: 'center', color: "inherit", fontSize: '13px' }}>{row.played}</td>
                                                <td style={{ padding: '12px 16px', textAlign: 'center', color: "inherit", fontWeight: 600, fontSize: '13px' }}>{row.wins}</td>
                                                <td style={{ padding: '12px 16px', textAlign: 'center', color: "inherit", fontSize: '13px' }}>{row.losses}</td>
                                                <td style={{ padding: '12px 16px', textAlign: 'center', color: "inherit", fontSize: '13px' }}>{row.draws}</td>
                                                <td style={{ padding: '12px 16px', textAlign: 'center', fontWeight: 900, color: "inherit", fontSize: '16px' }}>{row.points}</td>
                                            </tr>
                                        ))}
                                    </tbody>
                                </table>
                ...
                {tab === 'media' && (
                    <div>
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
                            <h2 style={{ color: "inherit", fontWeight: 800, fontSize: '22px' }}>📸 Media Gallery</h2>
                            {isOrganizer && (
                        ...
                        {showMediaModal && (
                            <div style={{
                                ...
                                <h3 style={{ color: "inherit", fontWeight: 800, fontSize: '16px', marginBottom: '16px' }}>Upload New Media</h3>
                                <form onSubmit={handleMediaUpload} style={{ display: 'grid', gap: '16px' }}>
                                    <div className="grid-cols-2-mobile" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
                                        <div>
                                            <label style={{ display: 'block', fontSize: '12px', color: "inherit", marginBottom: '6px' }}>Title *</label>
                                        ...
                                        <div>
                                            <label style={{ display: 'block', fontSize: '12px', color: "inherit", marginBottom: '6px' }}>Type *</label>
                                    ...
                                    <div>
                                        <label style={{ display: 'block', fontSize: '12px', color: "inherit", marginBottom: '6px' }}>URL (Image/Video Link) *</label>
                            ...
                            <div className="responsive-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '12px' }}>
                                {media.map((m: any) => (
                                    <div key={m.id} style={{ padding: '16px', borderRadius: '14px', background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.06)' }}>
                                        ...
                                        <div style={{ fontWeight: 700, color: "inherit", fontSize: '14px', marginBottom: '4px' }}>{m.title}</div>
                                        <div style={{ fontSize: '11px', color: "inherit" }}>{m.type} • {formatDate(m.createdAt)}</div>
                                        {m.url && <a href={m.url} target="_blank" rel="noopener noreferrer" style={{ display: 'inline-block', marginTop: '10px', fontSize: '12px', color: "inherit", textDecoration: 'none', fontWeight: 600 }}>View →</a>}
                                    </div>
                                ))}
                            </div>
                        )}
                ...
                {tab === 'chat' && (
                    <div>
                        <h2 style={{ color: "inherit", fontWeight: 800, fontSize: '22px', marginBottom: '20px' }}>💬 Tournament Chat</h2>
                        <div style={{ borderRadius: '16px', background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.06)', overflow: 'hidden' }}>
                            <div style={{ height: '400px', overflowY: 'auto', padding: '20px', display: 'flex', flexDirection: 'column', gap: '10px' }}>
                                {chatMessages.length === 0 ? (
                                    <div style={{ textAlign: 'center', padding: '60px 0', color: "inherit", fontSize: '13px' }}>No messages yet. Start the conversation!</div>
                                    ...
                                    <div key={msg.id} style={{
                                        ...
                                        <div style={{ fontSize: '13px', color: "inherit" }}>{msg.message}</div>
                                        <div style={{ fontSize: '10px', color: "inherit", marginTop: '4px' }}>{new Date(msg.createdAt).toLocaleTimeString()}</div>
                                    </div>
                                ))}
                            </div>
                            <div style={{ padding: '14px 20px', borderTop: '1px solid rgba(255,255,255,0.06)', display: 'flex', gap: '10px' }}>
                                <input value={chatInput} onChange={(e) => setChatInput(e.target.value)} onKeyDown={(e) => e.key === 'Enter' && sendChat()}
                                    placeholder="Type a message..." style={{ flex: 1, padding: '10px 14px', borderRadius: '10px', border: '1px solid rgba(255,255,255,0.1)', background: 'rgba(255,255,255,0.04)', color: "inherit", fontSize: '13px', outline: 'none' }} />
                ...
                {tab === 'settings' && isOrganizer && (
                    <div style={{ paddingBottom: '60px' }}>
                        <h2 style={{ color: "inherit", fontWeight: 800, fontSize: '22px', marginBottom: '20px' }}>⚙️ Tournament Settings</h2>
                        ...
                        <div className="responsive-grid" style={{ display: 'grid', gridTemplateColumns: '1.5fr 1fr', gap: '24px' }}>
                            ...
                            <div style={{ padding: '28px', borderRadius: '16px', background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.06)' }}>
                                <h3 style={{ color: "inherit", fontWeight: 800, fontSize: '16px', marginBottom: '16px' }}>General Information</h3>
                                {[
                                    ...
                                    <div key={label as string} style={{ display: 'flex', justifyContent: 'space-between', padding: '12px 0', borderBottom: '1px solid rgba(255,255,255,0.04)' }}>
                                        <span style={{ color: "inherit", fontSize: '13px', fontWeight: 500 }}>{label}</span>
                                        <span style={{ color: "inherit", fontSize: '13px', fontWeight: 700 }}>{val}</span>
                                    </div>
                                ))}
                            </div>
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                                <div style={{ padding: '24px', borderRadius: '16px', background: 'rgba(99,102,241,0.05)', border: '1px solid rgba(99,102,241,0.15)' }}>
                                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
                                        <h3 style={{ color: "inherit", fontWeight: 800, fontSize: '16px' }}>Registration Status</h3>
                                    ...
                                    <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                                        ...
                                        <span style={{ color: "inherit", fontSize: '14px', fontWeight: 600 }}>Currently {tournament.isRegistrationOpen ? 'OPEN' : 'CLOSED'}</span>
                                    </div>
                                </div>

                                <div style={{ padding: '24px', borderRadius: '16px', background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.06)' }}>
                                    <h3 style={{ color: "inherit", fontWeight: 800, fontSize: '16px', marginBottom: '16px' }}>Registration Settings</h3>
                                    <div key={tournament.id} style={{ display: 'grid', gap: '16px' }}>
                                        <div>
                                            <label style={{ display: 'block', fontSize: '12px', color: "inherit", marginBottom: '6px' }}>Max Teams</label>
                                        ...
                                        <div>
                                            <label style={{ display: 'block', fontSize: '12px', color: "inherit", marginBottom: '6px' }}>Registration Fee (₹)</label>
                                            <div style={{ display: 'flex', gap: '10px' }}>
                                        ...
                                        <div>
                                            <label style={{ display: 'block', fontSize: '12px', color: "inherit", marginBottom: '6px' }}>Approval Mode</label>
                                            <div style={{ display: 'flex', gap: '10px' }}>
